        ...
        <div className="bg-neutral sticky top-0 z-50 w-full">
            <div className="max-w-7xl mx-auto flex items-center justify-between p-4">
                ...
                <div className="max-w-7xl flex gap-y-6 gap-x-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 md:mt-0 items-center">
                        {/* Facebook */}
                        <a href="https://www.facebook.com/people/Zaneco-Perú/100063585188615/" className="mx-3 sm:mx-0" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" className="size-6 sm:w-5 sm:h-5" fill="currentColor" style={{ color: "#1877f2" }} viewBox="0 0 24 24">
                                <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                            </svg>
                        </a>

                        {/* Instagram */}
                        <a href="https://www.instagram.com/zanecoperu/" className="mx-3 sm:mx-0" target="_blank" rel="noopener noreferrer">
                        ...
                        {/* YouTube */}
                        <a href="https://www.youtube.com/@zanecosolution3433" className="mx-3 sm:mx-0" target="_blank" rel="noopener noreferrer">
