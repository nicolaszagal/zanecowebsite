            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between p-4">
                ...
                <div className="max-w-7xl flex gap-y-6 gap-x-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 md:mt-0 items-center">
                        {/* Facebook */}
                        <a href="https://www.facebook.com" className="mx-3 sm:mx-0" target="_blank" rel="noopener noreferrer">
                        ...
                        {/* Instagram */}
                        <a href="https://www.instagram.com" className="mx-3 sm:mx-0" target="_blank" rel="noopener noreferrer">
                        ...
                        {/* YouTube */}
                        <a href="https://www.youtube.com" className="mx-3 sm:mx-0" target="_blank" rel="noopener noreferrer">
