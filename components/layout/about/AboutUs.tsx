        ...
        <div className="bg-white py-24 px-6">
            <div className="max-w-7xl mx-auto">
                ...
                <p className="my-10 text-primary-700 text-justify">
                    ...
                    , es una empresa orientada a la comercialización de
                    alfombras y losetas de caucho. Nuestros proveedores son
                    empresas de amplia experiencia en el desarrollo de
                    productos de caucho, teniendo altos estándares de
                    calidad haciendo posible la comercialización de estos
                    productos en EEUU, Europa, Asia, Australia y Medio Oriente.
                </p>
                <div className="bg-primary-50/20 border-primary-500 border-l-4 my-10">
                    <div className="max-w-7xl mx-auto">
                        <p className="text-primary-700 p-10 text-justify">
                            ...
                            disminuyen el cansancio, los riesgos de accidentes y
                            las dolencias por mala postura, obteniéndose mejora en
                ...
                <p className="my-10 text-primary-700 text-justify">
                    ...
                    Plantas Procesadoras de Alimentos, Lavanderías Industriales,
                    Cocinas, empresas Mineras, Industria Pesquera entre otras.
                </p>
            </div>
        </div>
    )
